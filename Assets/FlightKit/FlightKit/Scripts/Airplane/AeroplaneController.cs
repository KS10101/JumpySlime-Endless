...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_MaxSpeed = 10f;              // Maximum speed possible to achieve with this ariplane.
        ...
        private void CaluclateAerodynamicEffect()
        {
            ...
            if (m_Rigidbody.velocity.magnitude > 0)
            {
                ...
                if (m_Rigidbody.velocity.sqrMagnitude > MaxSpeed * MaxSpeed * 0.01)
                {
                    var lookRotation = Quaternion.LookRotation(m_Rigidbody.velocity, transform.up);
                    m_Rigidbody.rotation = Quaternion.Slerp(m_Rigidbody.rotation, lookRotation, m_AerodynamicEffect*Time.deltaTime);
                }
            }
        }
